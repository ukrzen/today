(function() {
    ...
    function Calendar() {
        ...
        self.ready = function ($element) {
            ...
            endDate = endDate ? new Date( Date.parse(endDate)).clearTime() : null;
        ...
        self.showMonth = function (date) {
            ...
            $next.toggleClass("no-visible",currentMonth.getMonth() == 11);
